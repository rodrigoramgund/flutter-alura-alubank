  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(bottom: 8.0),
          child: ObjectivePoints(color: ThemeColors.accountPoints['freeDelivery'], text: "Entrega grátis: 15000pts"),
        ),
        ObjectivePoints(color: ThemeColors.accountPoints['streaming'], text: "1 mês de streaming: 30000pts"),
      ],
    );
  }
}
